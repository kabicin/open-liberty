 ...
 *******************************************************************************/
package com.ibm.ws.microprofile.health20.fails.to.start.health.checks.app;
...
public class BadServletContextListener implements ServletContextListener {
    ...
    private static final Logger LOG = Logger.getLogger(BadServletContextListener.class.getName());
