...
import com.ibm.ws.ras.instrument.internal.main.ReflectionHelper;
import com.ibm.ws.ras.instrument.internal.model.ThrowableInfo;
import com.ibm.ws.ras.instrument.internal.bci.remap.AddVersionFieldClassAdapter;
import com.ibm.ws.ras.instrument.internal.boot.templates.MethodProxy;

public class InstrumentProxyActivator {
	
//	final BundleContext bundleContext;
//	
//	final Instrumentation instrumentation;
//	
//	public final static String BOOT_DELEGATED_PACKAGE = "com.ibm.ws.boot.delegated.instrument";
//	public final static String METHOD_PROXY_CLASS_NAME = BOOT_DELEGATED_PACKAGE + "." + MethodProxy.class.getSimpleName();
//	public final static String METHOD_PROXY_CLASS_INTERNAL_NAME = METHOD_PROXY_CLASS_NAME.replaceAll("\\.", "/");
//	final static String TEMPLATE_CLASSES_PATH = MethodProxy.class.getPackage().getName().replaceAll("\\.", "/");
//	/**
...
//     */
//    final static String INSTRUMENT_VERSION_MANIFEST_HEADER = "Liberty-Instrument-Bundle-Version";
//    
//    final ThrowableInfo throwableInfo;
//    
//    private Class<?> methodProxyClass;
//
//	
//	 InstrumentProxyActivator(BundleContext bundleContext, ThrowableInfo throwableInfo, Instrumentation instrumentation) {
...
//	        JarFile proxyJar = getRasBootProxyJarIfCurrent();
//	        if (proxyJar == null) {
...
//
//	
//	        methodProxyClass = Class.forName(METHOD_PROXY_CLASS_NAME);
//	        // Hook up the proxies
//	        activateMethodProxyTarget();
//
//	        // now that the proxies are added, inject into the Throwable class.
//	        this.instrumentation.addTransformer(new ThrowableTransformer(new ThrowableInfo(this.instrumentation)), true);
//	        for (Class<?> clazz : this.instrumentation.getAllLoadedClasses()) {
//	            if (clazz.getName().equals("java.lang.Throwable")) {
//	                try {
//	                    System.out.println("Transforming 3!!");
...
//	    try {
//	        Class<?> clazz = Class.forName(METHOD_PROXY_CLASS_NAME);
...
//
//	/**
//     * Get the ras boot proxy jar from the current data area if the code
//     * matches the current bundle version.
//     *
//     * @return the proxy jar iff the proxy jar exits and matches this
//     *         bundle's version
//     */
//    JarFile getRasBootProxyJarIfCurrent() {
//        File dataFile = bundleContext.getDataFile("ras-boot-proxy.jar");
//        if (!dataFile.exists()) {
//            return null;
//        }
//
...
//            String jarVersion = attrs.getValue(INSTRUMENT_VERSION_MANIFEST_HEADER);
...
//
//        // Generate a manifest
//        Manifest manifest = createRasBootJarManifest();
//
//        // Create the file
...
//        org.osgi.framework.Bundle bundle = bundleContext.getBundle();
...
//     */
//    Manifest createRasBootJarManifest() {
//        Manifest manifest = new Manifest();
//
//        Attributes manifestAttributes = manifest.getMainAttributes();
//        manifestAttributes.putValue(Attributes.Name.MANIFEST_VERSION.toString(), "1.0");
//        manifestAttributes.putValue("Created-By", "Liberty Instrument Extender");
//        manifestAttributes.putValue("Created-Time", DateFormat.getInstance().format(new Date()));
//        manifestAttributes.putValue(INSTRUMENT_VERSION_MANIFEST_HEADER, getCurrentVersion());
//
//        return manifest;
//    }
//    
...
//     */
//    void activateMethodProxyTarget() throws Exception {
//    	// bind this class' instance to the proxy class
//    	findMethodProxySetTargetMethod().invoke(null, this);
//    	
//    	// bind this class' fireEnterMethod to the proxy class
//        Method enterMethod = ReflectionHelper.getDeclaredMethod(getClass(), "fireEnterMethod");
//        ReflectionHelper.setAccessible(enterMethod, true);
//        findMethodProxySetEnterMethod().invoke(null, enterMethod);
//        
//        // bind this class' fireReturnMethod to the proxy class
//        Method returnMethod = ReflectionHelper.getDeclaredMethod(getClass(), "fireReturnMethod");
//        ReflectionHelper.setAccessible(returnMethod, true);
//        findMethodProxySetReturnMethod().invoke(null, returnMethod);
//    }
//    
//    
//    /**
//     * Clear the instrument boot proxy delegate.
//     *
//     * @throws Exception the method invocation exception
//     */
//    void deactivateMethodProxyTarget() throws Exception {
//        findMethodProxySetEnterMethod().invoke(null, null, null);
//        findMethodProxySetReturnMethod().invoke(null, null, null);
//    }
//
//    Method findMethodProxySetTargetMethod() throws Exception {
//        Method method = ReflectionHelper.getDeclaredMethod(methodProxyClass, "setEnterMethod", Object.class, Method.class);
//        ReflectionHelper.setAccessible(method, true);
//        return method;
//    }
//
//    Method findMethodProxySetEnterMethod() throws Exception {
//        Method method = ReflectionHelper.getDeclaredMethod(methodProxyClass, "setEnterMethod", Object.class, Method.class);
//        ReflectionHelper.setAccessible(method, true);
//        return method;
//    }
//    
//    Method findMethodProxySetReturnMethod() throws Exception {
//        Method method = ReflectionHelper.getDeclaredMethod(methodProxyClass, "setReturnMethod", Object.class, Method.class);
//        ReflectionHelper.setAccessible(method, true);
//        return method;
//    }
//    
//    public void fireEnterMethod() {
