...
public class InstrumentationFrameworkExtender { //implements SynchronousBundleListener {
//
//    public final static String INSTRUMENTATION_COMPONENT_BUNDLE_HEADER = "Liberty-Instrument-Components";
...
//
//    private static final TraceComponent tc = Tr.register(InstrumentationFrameworkExtender.class);
//
